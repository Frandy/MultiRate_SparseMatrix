/*
 * CubicHermiteInterpolationInputSolver.h
 *
 *  Created on: Nov 23, 2015
 *      Author: delpopol
 */

#ifndef CUBICHERMITEINTERPOLATIONINPUTSOLVER_H_
#define CUBICHERMITEINTERPOLATIONINPUTSOLVER_H_

#include "StandardTypes.h"

using namespace Utils;

//! Input class for the cubic Hermite interpolator
class CubicHermiteInterpolationInputSolver {
public:
	CubicHermiteInterpolationInputSolver();
	virtual ~CubicHermiteInterpolationInputSolver();
...
#endif /* CUBICHERMITEINTERPOLATIONINPUTSOLVER_H_ */
